...
const fighterProfiles: FighterProfile[] = [
  ...
  },
  {
    ...
    bio: 'Explosive lightweight with a pace that never fades.',
    age: 28,
    weightClass: 'Lightweight',
    region: 'West',
    gym: 'Forge Athletics',
    ...
    heightCm: 177,
    reachCm: 182,
    walkoutSong: 'Thunderstruck',
    attributes: { power: 85, cardio: 90, grappling: 74, striking: 88 },
  },
  {
    userId: 'user-lena',
    nickname: 'Nightfall',
    bio: 'Calculated southpaw who thrives in championship rounds.',
    age: 27,
    ...
    heightCm: 175,
    reachCm: 178,
    walkoutSong: 'Midnight City',
    attributes: { power: 80, cardio: 92, grappling: 76, striking: 91 },
  },
  {
    userId: 'user-rafi',
    nickname: 'Iron Lion',
    bio: 'Pressure-heavy grinder with granite chin.',
    age: 30,
    ...
    reachCm: 188,
    walkoutSong: 'Roar',
    attributes: { power: 88, cardio: 80, grappling: 82, striking: 77 },
  },
  {
    userId: 'user-mira',
    nickname: 'Flash',
    bio: 'Counter striker with blinding hand speed.',
    age: 24,
    ...
    heightCm: 163,
    reachCm: 165,
    walkoutSong: 'Light Speed',
    attributes: { power: 68, cardio: 89, grappling: 72, striking: 86 },
  },
  {
    userId: 'user-eden',
    nickname: 'Flow',
    bio: 'Submission hunter with fluid transitions.',
    age: 29,
    weightClass: 'Featherweight',
    region: 'East',
    ...
    reachCm: 175,
    walkoutSong: 'Waves',
    attributes: { power: 66, cardio: 85, grappling: 94, striking: 73 },
  },
];
...
const events: Event[] = [
  ...
  },
  {
    ...
    description: 'Round-robin brackets with mat-side coaching and hydration checks.',
  ...
  },
  {
    ...
    description: 'Invite-only friendly MMA card with advanced safety protocols.',
...
const waivers: Waiver[] = [
  ...
  },
  {
    ...
    eventId: 'event-2',
    userId: 'user-eden',
    signedAt: new Date(Date.now() - 1000 * 60 * 60 * 12),
  },
  {
    id: 'waiver-3',
    eventId: 'event-3',
    userId: 'user-kai',
    signedAt: new Date(Date.now() - 1000 * 60 * 30),
  },
];
...
const eventReviews: EventReview[] = [
  ...
  },
  {
    ...
    userId: 'user-eden',
    rating: 5,
    comment: 'Loved the bracket format and quick resets.',
    status: EventReviewStatus.APPROVED,
  ...
  },
  {
    ...
    userId: 'user-kai',
    rating: 3,
    comment: 'Tough opponents, would appreciate earlier bout order.',
    status: EventReviewStatus.PENDING,
...
const ticketSales: TicketSale[] = [
  ...
  { id: 'sale-3', eventId: 'event-2', price: 25, qty: 80, channel: 'Online' },
  { id: 'sale-4', eventId: 'event-3', price: 30, qty: 60, channel: 'Online' },
];
...
const eventExpenses: EventExpense[] = [
  ...
  { id: 'expense-4', eventId: 'event-2', category: 'Mat cleaning', amount: 250 },
  { id: 'expense-5', eventId: 'event-3', category: 'Venue', amount: 900 },
];
...
const bouts: Bout[] = [
  ...
  },
  {
    ...
    date: new Date(Date.now() + 1000 * 60 * 60 * 24 * 21),
    weightClass: 'Featherweight',
    redFighterId: 'user-eden',
    blueFighterId: 'user-mira',
    result: BoutResult.RED,
    method: BoutMethod.SUB,
    round: 1,
    time: '2:15',
  },
  {
    ...
    date: new Date(Date.now() + 1000 * 60 * 60 * 24 * 35),
    weightClass: 'Welterweight',
    redFighterId: 'user-kai',
    blueFighterId: 'user-lena',
    result: BoutResult.DRAW,
    method: BoutMethod.DEC,
    round: 3,
    time: '3:00',
  },
  {
    id: 'bout-4',
    eventId: 'event-3',
    date: new Date(Date.now() + 1000 * 60 * 60 * 24 * 35 + 1000 * 60 * 30),
    weightClass: 'Middleweight',
    redFighterId: 'user-rafi',
    blueFighterId: 'user-diego',
    result: BoutResult.RED,
    method: BoutMethod.KO,
    round: 2,
    time: '1:10',
  },
];
...
const eventChatMessages: EventChatMessage[] = [
  ...
  },
  {
    ...
    senderId: 'user-eden',
    role: Role.FIGHTER,
    body: 'Anyone want to drill guard passes before brackets start?',
    createdAt: new Date(Date.now() - 1000 * 60 * 20),
  },
  {
    id: 'chat-3',
    ...
    senderId: 'user-organizer',
    role: Role.ORGANIZER,
    body: 'Bout order will post in 30 minutes—stay warmed up!',
